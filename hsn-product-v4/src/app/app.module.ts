...
import { WriteLogService } from './services/log/write-log.service';
...
@NgModule({
  ...
  providers: [{ provide: LogService, useFactory: createLogService, deps: [WriteLogService] }, ProductService, ShoppingCartService, WriteLogService],
